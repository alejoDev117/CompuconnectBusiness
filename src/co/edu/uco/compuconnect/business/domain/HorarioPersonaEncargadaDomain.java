...
public class HorarioPersonaEncargadaDomain {
	...
	private HorarioPersonaEncargadaDomain() {
		...
		setPersonaEncargada(PersonaEncargadaDomain.getDefaultObject());
	...
	private final void setPersonaEncargada(PersonaEncargadaDomain personaEncargada) {
		this.personaEncargada = UtilObject.getDefault(personaEncargada, PersonaEncargadaDomain.getDefaultObject());
	}
